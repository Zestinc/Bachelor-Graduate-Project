...
//{
//    MYSQL mysql = initsql();
//    if(!freopen("symptom2symptom.txt", "r", stdin))
...
//    
//    
//    string symbol; //symptom1
//    string content;//symptom2
//    while(getline(cin, content))
//    {
//        content = content.substr(0, content.length() - 1);
//        unsigned long first_pos = content.find_first_of('\t');
//        
//        symbol = content.substr(0, first_pos - 1);
////        cout<<symbol<<endl;
//        quote_handle(symbol);
//        content = content.substr(first_pos + 1, string::npos);
//        quote_handle(content);
//        
//        string sql = "insert into symptom2symptom(symptom1, symptom2)values(\"";
//        sql += symbol + "\",\"" + content + "\");";
//        
